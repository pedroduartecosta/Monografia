...
This architecture allows for the use of several oracle nodes and different minimum voting quorums to achieve higher levels of trust, include more parties or increase service availability. Nonetheless, the higher the number of oracles the higher the cost per transaction. Table \ref{oracle-query-cost} shows the cost each query in Euros (queried Google Finance on the 22th of May, 2019) using different numbers of oracles.
...
\begin{figure}[H]
  ...
  \begin{tikzpicture}
    ...
    \end{axis}
  \end{tikzpicture}
  \caption{Cost per query using a consensus of 2/3.}
