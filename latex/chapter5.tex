...
\subsection{Known Uses}
Chainlink~\ref{Ellis2017} is a known use case of a service that differentiates itself from the competition by using a decentralized network of oracles to guarantee data veracity and availability. Chainlink is partenering with Oraclize.it to integrate Oraclize.it service with authenticity proofs into the decentralized network of Chainlink.
