...
%FIXME: Antes desta secção falta uma secção sobre o projecto, com informação sobre onde está o repositório, com que licença é disponibilizado, e como é que se usa do ponto de vista de quem quer correr um oracle e do ponto de vista de quem quer usar a tua implementação como framework para desenvolver o seu próprio oracle
