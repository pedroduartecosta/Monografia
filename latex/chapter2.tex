...
%% FIXME: Explain all bottom steps
...
%% FIXME: Explain the search query
...
\addplot[
    ...
    coordinates {
    (2015,1)(2016,11)(2017,38)(2018,70)(2019,3)
    };
...
%% FIXME: Era excelente apresentar em anexo a lista de artigos que apareceu neste ponto, bem como as listas de artigos que foram ficando (e que foram sendo excluidas) em cada uma das fases ao descer no diagrama. Isto pode ser uma única tabela com os artigos todos que surgiram no início e a fase em que foram excluídos (se o foram). Se fores por esta via, acho que dará jeito numerar cada uma destas fases pela sequência em que acontecem, e na tabela também apresentar essa numeração.

%% FIXME: referir a figurar no texto
...
%% FIXME: describe a bit further the incetives mechanisms found
