...
This architecture achieves a \textbf{fast time-to-market}, allowing the devleper of the smart-contract to quickly retrieve data from the web by simplying plugin-in a oracle-as-a-service solution.
