...
%FIXME: No fim da introdução devia haver uma visão geral do artigo. isto não é uma mera listagem de secções (embora possas referir as secções principais), serve para dar uma ideia do fio condutor que se pode esperar encontrar no resto do artigo
...
%FIXME: colocar a explicação debaixo de cada pergunta
...
%FIXME: Esta é a secção mais importante deste artigo, e por isso devia crescer mais e ter mais destaque:
%- muda-lhe o nome para algo como "Results"
%-  Traz para aqui para cima a tabela 2
%- embora a tabela já diga quais são os oracles de cada tipo, não faz mal se os referires de passagem como exemplos aqui no texto
%- tenta dar aqui uma resposta às RQs que estabeleces no início (se necessário, ajusta o texto das RQs para o que fizer mais sentido)
