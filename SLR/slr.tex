...
\author[add1]{Filipe Figueiredo Correia\corref{supervisor}}
\ead{ffcorreia@fe.up.pt}
\author[add1]{Hugo Sereno Ferreira\corref{supervisor}}
\ead{hugosf@fe.up.pt}
\author[add2]{Mário Ribeiro Alves\corref{proponent}}
\ead{mario@brpx.com}
...
\cortext[supervisor]{Supervisors}
\cortext[proponent]{Proponent}
